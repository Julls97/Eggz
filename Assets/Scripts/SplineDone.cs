...
public class SplineDone : MonoBehaviour {
	...
	public void FlipPoints() {
		foreach (var anchor in anchorList) {
			anchor.handleAPosition =
				new Vector3(-anchor.handleAPosition.x, anchor.handleAPosition.y, anchor.handleAPosition.z);
			anchor.handleBPosition =
				new Vector3(-anchor.handleBPosition.x, anchor.handleBPosition.y, anchor.handleBPosition.z);
